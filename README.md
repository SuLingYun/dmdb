...
├── rsync-inotify-sync.sh   # rsync+inotify 实时文件同步工具（支持本地/备份服务器双模式）
├── inotify-tools-3.22.1.0.tar.gz  # inotify-tools 源码包（同步工具依赖）
├── README.md               # 项目说明文档
...
| [RSYNC_SYNC.md](RSYNC_SYNC.md) | rsync+inotify 实时同步工具使用指南 |
